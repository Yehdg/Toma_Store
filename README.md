...
##  專案簡介
這是一個全端 Web 應用程式，採用MVC架構，提供完整的線上購物平台。用戶可以瀏覽商品、加入購物車並進行下訂單，會員系統支援註冊登入、個人資料管理、頭像上傳，以及購買歷史紀錄的查詢功能。
...
購物車頁面會顯示有加入購物車的商品，會員可以選擇修改數量、刪除商品、結帳所有商品。
